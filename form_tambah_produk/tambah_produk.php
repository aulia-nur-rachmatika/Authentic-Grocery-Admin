                ...
                <div class="card-body">
                    <form action="aksi_tambah_produk.php" method="POST">
                        ...
                        <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    <input class="input--style-6" type="text" name="nama" placeholder="nama_produk">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    <input class="input--style-6" type="text" name="merk" placeholder="merk">
                                </div>
                            </div>
                        </div>
                        <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    <input class="input--style-6" type="text" name="harga" placeholder="harga">
                              </div>
                        </div>
</div>
...
<div class="card-body">
                    <form action="aksi_tambah_produk.php" method="POST">
                        <div class="form-row">
                            <div class="name" >ID</div>
                            <div class="value">
                                <input class="input--style-6" type="text" name="id_stok" value="<?=$idstok;?>" readonly placeholder="id">
                            </div>
                        </div>
                        <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    <input class="input--style-6" type="text" name="stok" placeholder="stok">
                                </div>
                            </div>
                        </div>
